...
export function MysteryBoxSection() {
  return (
    <section className="border-y border-gray-200 bg-gray-50 py-16 dark:border-white/8 dark:bg-[#0d0d0d]">
      <div className="mx-auto max-w-screen-lg px-4 sm:px-6">
        {/* Section header */}
        <div className="mb-10 flex items-center gap-3">
          <div className="h-7 w-1.5 rounded-full bg-[#E69900]" />
          <h2 className="text-xl font-black text-gray-900 dark:text-white">קופסת המסתורין</h2>
          <span className="rounded-4 bg-[#cf2e2e] px-2 py-0.5 text-[10px] font-black text-white">HOT</span>
        </div>
        ...
        <div className="grid grid-cols-1 gap-10 md:grid-cols-2 md:items-center">
          ...
          <div className="relative">
            <div
              className="absolute inset-0 rounded-24 opacity-20 blur-2xl dark:opacity-30"
          ...
          <div className="flex flex-col gap-6">
            <div>
              <p className="text-sm font-bold uppercase tracking-widest text-[#E69900]">🏆 מונדיאל 2026</p>
              <h3 className="mt-2 text-3xl font-black leading-tight text-gray-900 dark:text-white">
                קבל חולצת נבחרת<br />
            ...
            <div className="grid grid-cols-4 gap-2 sm:grid-cols-5">
              {wc2026Nations.map((n) => (
                <div
                  key={n.name}
                  className="flex flex-col items-center gap-1 rounded-12 border border-gray-200 bg-white py-2.5 px-1 dark:border-white/10 dark:bg-white/5"
                >
                  <span className="text-2xl leading-none">{n.flag}</span>
                  <span className="text-center text-[10px] font-semibold leading-tight text-gray-600 dark:text-gray-400">
                    {n.name}
                  </span>
                </div>
              ))}
